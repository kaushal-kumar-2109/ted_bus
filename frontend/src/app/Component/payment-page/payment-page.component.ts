...
constructor(private route:ActivatedRoute, private dataservice : DataserviceService,private http:HttpClient,private busservice:BusService, public lang: LanguageService, private router: Router){}
ngOnInit(): void {
